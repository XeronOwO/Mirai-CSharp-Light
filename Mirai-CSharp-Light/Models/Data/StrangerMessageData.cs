...
{
	internal class StrangerMessageData : IStrangerMessageData
	{
		public string type = "";
		...
		public static StrangerMessageData Parse(JObject json)
		{
			var result = JsonConvert.DeserializeObject<StrangerMessageData>(json.ToString(Formatting.None));
