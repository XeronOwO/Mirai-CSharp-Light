...
{
	internal class TempMessageData : ITempMessageData
	{
		public string type = "";
		...
		[JsonIgnore]
		public ITempSenderData Sender => sender;
		...
		public static TempMessageData Parse(JObject json)
		{
			var result = JsonConvert.DeserializeObject<TempMessageData>(json.ToString(Formatting.None));
