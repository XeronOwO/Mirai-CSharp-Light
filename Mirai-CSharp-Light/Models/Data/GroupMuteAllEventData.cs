...
{
	internal class GroupMuteAllEventData : IGroupMuteAllEventData
	{
		public string type = "";
		...
		public static GroupMuteAllEventData Parse(JObject json) => JsonConvert.DeserializeObject<GroupMuteAllEventData>(json.ToString(Formatting.None));
	}
}
